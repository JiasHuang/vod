...
var settings_defs = {
    ...
    'format' : {
        ...
        'http-480p':'59/35/best[ext!=webm][protocol^=http][height<=480]',
        'http-360p':'18/34/best[ext!=webm][protocol^=http][height<=360]',
        '1080p':'37/best[ext!=webm][height<=1080]',
        '720p':'22/best[ext!=webm][height<=720]',
        '480p':'59/35/best[ext!=webm][height<=480]',
        '360p':'18/34/best[ext!=webm][height<=360]',
        'audio-only':'bestaudio',
        'default':'22/59/35/best[ext!=webm][protocol^=http]',
    },
    'username' : {
        'default':'',
    },
